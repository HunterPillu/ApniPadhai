...
public class MessageButtonBehaviourOnPageSelected implements IPageSelectedListener {
    ...
    public MessageButtonBehaviourOnPageSelected(AppCompatButton messageButton, SlidesAdapter adapter, SparseArray<MessageButtonBehaviour> messageButtonBehaviours) {
